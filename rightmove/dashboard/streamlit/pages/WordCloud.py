...
filter_words = st.text_input("Enter words to filter out (separated by commas) and regenerate wordcloud:")
...
if filter_words:
    ...
    filtered_corpus = " ".join([word for word in corpus.split() if word.lower() not in filter_words_list])
else:
